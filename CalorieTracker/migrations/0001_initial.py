# Generated by Django 3.2.7 on 2021-09-25 21:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('relatedClient', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='CalorieTracker.client')),
            ],
        ),
        migrations.CreateModel(
            name='ConsumedFood',
            fields=[
                ...
                ('relatedClient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='CalorieTracker.client')),
                ('relatedFood', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='CalorieTracker.food')),
            ],
        ),
        migrations.AddField(
            model_name='client',
